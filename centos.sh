...
rpm -ivh https://tutu.bid/bash/serverspeeder/centos/kernel-firmware-2.6.32-504.3.3.el6.noarch.rpm
rpm -ivh https://tutu.bid/bash/serverspeeder/centos/kernel-2.6.32-504.3.3.el6.x86_64.rpm --force
...
rpm -ivh https://tutu.bid/bash/serverspeeder/centos/kernel-3.10.0-229.1.2.el7.x86_64.rpm --force
