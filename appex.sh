...
URLKernel='https://tutu.bid/bash/serverspeeder/files/kernel/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://tutu.bid/bash/serverspeeder/files/kernel/$MyKernel"
...
wget --no-check-certificate -q -O "/appex/etc/apx.lic" "https://tutu.bid/bash/serverspeeder/files/mac/index.php?m=$MAC&y=2099&b=0"
...
{
[ ! -f /tmp/appex.zip ] && wget --no-check-certificate -q -O "/tmp/appex.zip" "https://tutu.bid/bash/serverspeeder/files/kernel/appex.zip"
